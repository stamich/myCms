...
@Entity
@NamedEntityGraphs({@NamedEntityGraph(name = User.SHALLOW_GRAPH_NAME, attributeNodes = {@NamedAttributeNode("roles")}),
		@NamedEntityGraph(name = User.DEEP_GRAPH_NAME, attributeNodes = {@NamedAttributeNode("roles")})})
@Table(name = "user")
@DynamicInsert
@DynamicUpdate
@Indexed
