...
@Configuration
@EnableCaching
public class MyCmsCacheConfiguration extends CachingConfigurerSupport {
	...
	private static Logger logger = LoggerFactory.getLogger(MyCmsCacheConfiguration.class);
