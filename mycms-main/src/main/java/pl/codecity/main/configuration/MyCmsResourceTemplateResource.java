...
public class MyCmsResourceTemplateResource implements ITemplateResource {
	...
	public MyCmsResourceTemplateResource(final ApplicationContext applicationContext, final String location, final String characterEncoding) {
		super();
	...
	public MyCmsResourceTemplateResource(final Resource resource, final String characterEncoding) {
		super();
